...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
		for bp in orm['basic_profiles.Profile'].objects.all():
			print "Migrating profile %s" % bp
			profile = orm.CondottieriProfile.objects.create(user=bp.user,
													name=bp.name,
													about=bp.about,
    ...
    complete_apps = ['basic_profiles', 'condottieri_profiles']
