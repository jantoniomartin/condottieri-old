...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CondottieriProfile'
        db.create_table('condottieri_profiles_condottieriprofile', (
        ...
        db.send_create_signal('condottieri_profiles', ['CondottieriProfile'])


    def backwards(self, orm):
        
        # Deleting model 'CondottieriProfile'
        db.delete_table('condottieri_profiles_condottieriprofile')
    ...
    complete_apps = ['condottieri_profiles']
